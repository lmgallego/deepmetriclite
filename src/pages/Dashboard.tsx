    ...
    <div className="min-h-screen bg-netflix-black text-white p-8 pt-24">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Intervals Data Doctor Card - ACTIVE */}
          <div 
            onClick={() => navigate('/data-doctor')}
            className="group bg-[#181818] rounded-xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-yellow-900/20 border border-gray-800 hover:border-yellow-900/50"
          >
            <div className="h-40 bg-gradient-to-br from-yellow-900 to-black relative overflow-hidden">
               <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=1470&auto=format&fit=crop')] bg-cover bg-center opacity-40 group-hover:opacity-50 transition-opacity" />
            ...
            <div className="p-6">
              <h3 className="text-xl font-bold mb-2 group-hover:text-yellow-500 transition-colors">Intervals Data Doctor</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                {isSpanish 
